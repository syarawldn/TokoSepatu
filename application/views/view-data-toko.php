 ...
 <h1 class="h4 text-gray-900 mb4"><font color="7F00FF"><b><u>Hasil Data Toko Sepatu,</font></b></u></h1></h1>
 </div>
   <div class="mb-3">
     <label>Nama</label>
 ...
 <div class="mb-3">
    ...
    <div class="mb-3">
       ...
       <div class="mb-3">
        ...
        <a href="<?= base_url('Sepatu');?>" type="submit" class="btn btn-warning btn-user btn-block">Kembali
        </a>
       <hr>
