 ...
 <h1 class="h4 text-gray-900 mb4"><font color="7F00FF"><b><u>Form Input Transaksi Toko Sepatu</font></b></u></h1>
 <br>
 </div>
 ...
 <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <button type="submit" value="submit" class="btn btn-warning btn-user btn-block">Submit
         </button>
       </form>
       <hr>
       <div class="container my-auto">
           <div class="copyright text-center my-auto">
              <!--- <span>Copyright &copy; Your Website 2020</span> !-->
                Crafted by <a href="https://instagram.com/syarawldn" target="_blank"> Syara Waldana.</a>
